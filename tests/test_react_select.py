...
async def main():
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            if control:
                ...
                if menu:
                    ...
                    await page.screenshot(path="/Users/fareezahmed/Desktop/job-hunter-agent/screenshots/react_select_attempt1.png", full_page=True)
        ...
        await page.screenshot(path="/Users/fareezahmed/Desktop/job-hunter-agent/screenshots/react_select_final.png", full_page=True)
