              ...
              <div className="flex flex-col items-center">
                <div
                  className={cn(
                    ...
                    isCompleted && "bg-zinc-900 dark:bg-white border-zinc-900 dark:border-white text-white dark:text-zinc-900",
                    isCurrent && "border-zinc-900 dark:border-white text-zinc-900 dark:text-white",
                    !isCompleted && !isCurrent && "border-zinc-300 dark:border-zinc-700 text-zinc-400"
                  )}
                >
                ...
                <span className={cn(
                  ...
                  (isCurrent || isCompleted) ? "text-zinc-900 dark:text-white font-medium" : "text-zinc-400"
                )}>
                  {step.label}
                </span>
              </div>
