...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        form.add_field("first_name", "Fareez")
        form.add_field("last_name", "Ahmed")
        form.add_field("email", "Fareez.Ahmed@gmail.com")
        form.add_field("phone", "2026770160")

        # Add resume file
        with open(resume_path, "rb") as f:
            resume_data = f.read()
        form.add_field("resume", resume_data,
                       filename="Fareez_Ahmed_Resume.pdf",
        ...
        for q in questions:
            ...
            if field_type == "input_text":
                if "linkedin" in label:
                    form.add_field(f"question_{q_id}", "https://www.linkedin.com/in/fareezahmed/")
