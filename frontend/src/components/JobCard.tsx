    ...
    return (
      <div
        className={`border rounded p-2 text-xs cursor-pointer transition-colors ${
          selected ? "border-blue-500 bg-blue-50 dark:bg-blue-950" : "hover:bg-zinc-50 dark:hover:bg-zinc-900"
        }`}
      ...
      >
        ...
        <p className="text-zinc-500 truncate">{job.company} — {job.location}</p>
      </div>
    );
  }
