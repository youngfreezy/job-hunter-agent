...
def _set_nextauth_secret(monkeypatch):
    ...
    # Patch the already-instantiated settings singleton (env var alone isn't
    # enough because Settings() was created at import time).
    from backend.shared.config import settings
    monkeypatch.setattr(settings, "NEXTAUTH_SECRET", "test-secret-for-ci")
