      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-1">
            All your applications in one place. Download tailored resumes and
            cover letters, or finish applications that need your attention.
          </p>
        </div>
                      ...
                      <div className="mt-3 pt-3 border-t border-border/50">
                        ...
                        {expandedScreenshot === key && (
                          <div className="mt-2 rounded-lg border border-border overflow-hidden">
                            ...
                            <img
                              src={`${API_BASE}/api/sessions/${entry.sessionId}/screenshot?path=${encodeURIComponent(entry.screenshot_path)}`}
