...
const plans = [
  {
    ...
    apps: 25,
    features: [
      "Status Feed (live text updates)",
      "25 applications/week",
      "Resume coaching & scoring",
  ...
  },
  {
    ...
    apps: 200,
    features: [
      "Live browser takeover (on-demand)",
...
const steps = [
  {
    ...
    desc: "Upload your resume, enter your target keywords, locations, and preferences.",
  },
  {
    num: "2",
    title: "AI Career Coach",
    desc: "Our AI rewrites your resume as a personal salesperson, scores it, and builds cover letter templates.",
  },
  {
    num: "3",
    title: "Discover & Score",
    desc: "Agents scan Indeed, LinkedIn, Glassdoor, ZipRecruiter, and Google Jobs simultaneously.",
  },
  {
    num: "4",
    title: "Review & Approve",
    desc: "Review the shortlist with fit scores. Approve which jobs to apply to.",
  },
  {
    num: "5",
    title: "Watch & Steer",
    desc: "Watch the agent apply in real-time. Chat to steer it, or take direct browser control.",
  },
  {
    num: "6",
    title: "Get Results",
    desc: "Receive a detailed report with submission proofs, metrics, and next steps.",
  },
];
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      ...
      <section className="px-6 py-24 text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl text-zinc-600 dark:text-zinc-400 mb-8 max-w-2xl mx-auto">
          ...
          generates cover letters, and submits applications — while you watch
          and steer in real-time.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <Card
              ...
              className={
                plan.popular
                  ? "border-zinc-900 dark:border-white border-2 relative"
                  : ""
              }
            >
              {plan.popular && (
